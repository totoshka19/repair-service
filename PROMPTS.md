...
04.03.2026 11:37 На странице логина поменяй плейсхолдеры на "Введите логин" и "Введите пароль". Добавь иконку глазика в инпут пароля. При наведении на него пароль должен показываться.

---

04.03.2026 11:45 На странице логина ниже формы добавь кнопку, при нажатии на которую в новой вкладке будет открываться страница создания заявки.

---

04.03.2026 11:52 Поменяй плейсхолдеры в форме создания заявки на "Введите ваше имя", "Введите ваш адрес", "Опишите вашу проблему". В инпут ввода номера телефона добавь маску react-imask. Вводить туда можно только цифры.

---

04.03.2026 12:00 Добавь cursor pointer ко всем кнопкам в проекте.

---

04.03.2026 12:07 При переключении между фильтрами контент дергается из-за вертикального скрол-бара справа. Исправь это.

---

04.03.2026 12:15 При нажатии на кнопку фильтрации есть небольшое смещение, убери его.

---

04.03.2026 12:20 Создай полноценное модальное окно назначения мастера.

---

04.03.2026 12:22 При открытии модального окна есть небольшое смещение контента, убери его.

---

04.03.2026 12:26 Добавь отступ между инпутом выбора мастера и кнопками.

---

04.03.2026 12:30 Селект выбора мастера наслаивается на инпут, такого не должно быть. При активном выпадающем списке галочка в инпуте должна на 180 градусов поворачиваться.

---

04.03.2026 12:33 Раскрывающийся список с мастерами должен ниже инпута отображаться.

---

04.03.2026 12:35 Увеличь высоту модального окна, чтобы было место для раскрывающегося списка. Кнопки прижми внизу.

---

04.03.2026 12:50 В инпуте "Адрес" в форме создания заявки какая сейчас схема валидации?

---

04.03.2026 12:52 Исправь текст ошибки на "Введите адрес (минимум 5 символов)".

---

04.03.2026 12:54 Почему при пустом поле телефона показывается ошибка "Invalid input: expected string, received undefined"?

---

04.03.2026 12:56 Какие заголовки сейчас у страниц приложения?

---

04.03.2026 12:58 У каждой страницы должен быть свой подходящий по смыслу заголовок.

---

04.03.2026 13:07 При логине надпись на кнопке "Войти" сначала меняется на "Вход...", потом опять на "Войти" и уже затем происходит открытие страницы панели. Это не правильно, исправь, чтобы при успешном входе сразу открывалась панель.

---

04.03.2026 13:18 Какие еще тесты можно написать для проекта?
